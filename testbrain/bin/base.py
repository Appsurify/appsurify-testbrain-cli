"""Click customizations for Testbrain."""
import json
import numbers
...
from testbrain.utils.functional import cached_property
...
class TestbrainOption(click.Option):
    """Customized option for Testbrain."""
...
class TestbrainCommand(click.Command):
    """Customized command for Testbrain."""
...
class TestbrainDaemonCommand(TestbrainCommand):
    ...
    def __init__(self, *args, **kwargs):
        """Initialize a Testbrain command with common daemon options."""
        super().__init__(*args, **kwargs)
