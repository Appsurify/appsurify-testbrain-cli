...
RESERVED_LOGGER_NAMES = {'testbrain', 'testbrain.task'}

# Sets up our logging hierarchy.
#
# Every logger in the testbrain package inherits from the "testbrain"
# logger, and every task logger inherits from the "testbrain.task"
# logger.
base_logger = logger = _get_logger('testbrain')
...
task_logger = get_logger('testbrain.task')
worker_logger = get_logger('testbrain.worker')
