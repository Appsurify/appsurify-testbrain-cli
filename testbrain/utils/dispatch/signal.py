...
from testbrain.exceptions import CDeprecationWarning
from testbrain.local import PromiseProxy, Proxy
from testbrain.utils.functional import fun_accepts_kwargs
from testbrain.utils.log import get_logger
from testbrain.utils.time import humanize_seconds
from testbrain.utils.functional import retry_over_time
...
class Signal:  # pragma: no cover
    ...
    def send(self, sender, **named):
        ...
        Django signals. In Testbrain "send" and "send_robust" do the same thing.)
