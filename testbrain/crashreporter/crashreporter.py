...
from testbrain.crashreporter.process import CrashReportingProcess
from testbrain.crashreporter.tools import analyze_traceback, repr as safe_repr
...
class CrashReporter(object):
    ...
    def _analyze_traceback(self, traceback):
        ...
        overriden = self.__class__.custom_inspection.__name__ is not CrashReporter.custom_inspection.__name__
        if overriden:
