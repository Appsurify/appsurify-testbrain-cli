...
__keywords__ = 'testbrain cli'

# -eof meta-

__all__ = ('Testbrain', 'current_app')
...
if STATICA_HACK:  # pragma: no cover
    from testbrain._state import current_app
...
def maybe_patch_concurrency(argv=None, short_opts=None,
    ...
    try:
        ...
        from testbrain import concurrency
...
old_module, new_module = local.recreate_module(  # pragma: no cover
    __name__,
    by_module={
        'testbrain.app': ['Testbrain'],
        'testbrain._state': ['current_app'],
        'testbrain.utils': ['uuid'],
    },
    __package__='testbrain', __file__=__file__,
