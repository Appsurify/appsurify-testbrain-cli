...
from testbrain.exceptions import reraise
from testbrain.utils.collections import DictAttribute, force_mapping
from testbrain.utils.functional import maybe_list
from testbrain.utils.imports import (NotAPackage, find_module, import_from_cwd, symbol_by_name)
...
class BaseLoader:
    ...
    Loaders handles,
        ...
        * Reading testbrain client/worker configurations.
    ...
    def on_worker_init(self):
        """Called when the worker (:program:`testbrain worker`) starts."""

    def on_worker_shutdown(self):
        """Called when the worker (:program:`testbrain worker`) shuts down."""
    ...
    def cmdline_config_parser(self, args, namespace='testbrain',
        ...
        from testbrain.app.defaults import NAMESPACES, Option
    ...
    def read_configuration(self, env='TESTBRAIN_CONFIG_MODULE'):
        try:
