...
from testbrain.libs.client.compat import connection, poolmanager
from testbrain.libs.client.exceptions import RequestsVersionTooOld
...
class SocketOptionsAdapter(adapters.HTTPAdapter):
    ...
    Example usage::
        ...
        >>> import socket
        >>> import requests
        >>> from testbrain.client.adapters import SocketOptionsAdapter
        >>> s = requests.Session()
