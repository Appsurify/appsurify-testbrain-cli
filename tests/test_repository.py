...
class TestRepositoryGitVCS:
    ...
    def test_git_vcs_process_log(self, fp):
        ...
        fp.register("git config diff.renames 0", stdout=[""])
        fp.register(
            'git log -n 4 --abbrev=40 --full-diff --full-index --remotes main --reverse --numstat -p --pretty=format:"%nCOMMIT:%x09%H%nTREE:%x09%T%nDATE:%x09%aI%nAUTHOR:%x09%an%x09%ae%x09%aI%nCOMMITTER:%x09%cn%x09%ce%x09%cI%nMESSAGE:%x09%s%nPARENTS:%x09%P%n" HEAD',
            stdout=[
                (
                    "COMMIT:\t5355a13f5ba44d23de9a3090ad976d63d1a60e3e\n"
                    "TREE:\ta2bd09a6cc8a36da7fd43a3b8445967584873e5e\n"
        ...
        fp.register(
            'git log -n 4 --abbrev=40 --full-diff --full-index --reverse --numstat -p --pretty=format:"%nCOMMIT:%x09%H%nTREE:%x09%T%nDATE:%x09%aI%nAUTHOR:%x09%an%x09%ae%x09%aI%nCOMMITTER:%x09%cn%x09%ce%x09%cI%nMESSAGE:%x09%s%nPARENTS:%x09%P%n" HEAD',
            stdout=[
                (
                    "COMMIT:\t5355a13f5ba44d23de9a3090ad976d63d1a60e3e\n"
                    "TREE:\ta2bd09a6cc8a36da7fd43a3b8445967584873e5e\n"
        ...
        commits_data = vcs.process.log(rev="HEAD", number=4, raw=False)
    ...
    def test_git_get_commits(self, fp):
        ...
        fp.register(
            'git log -n 1 --abbrev=40 --full-diff --full-index --remotes main --reverse --pretty=format:"%nCOMMIT:%x09%H%nTREE:%x09%T%nDATE:%x09%aI%nAUTHOR:%x09%an%x09%ae%x09%aI%nCOMMITTER:%x09%cn%x09%ce%x09%cI%nMESSAGE:%x09%s%nPARENTS:%x09%P%n" 5355a13f5ba44d23de9a3090ad976d63d1a60e3e',
            stdout=[
                (
                    "COMMIT:\t5355a13f5ba44d23de9a3090ad976d63d1a60e3e\n"
                    "TREE:\ta2bd09a6cc8a36da7fd43a3b8445967584873e5e\n"
        ...
        fp.register(
            'git log -n 1 --abbrev=40 --full-diff --full-index --remotes main --reverse --pretty=format:"%nCOMMIT:%x09%H%nTREE:%x09%T%nDATE:%x09%aI%nAUTHOR:%x09%an%x09%ae%x09%aI%nCOMMITTER:%x09%cn%x09%ce%x09%cI%nMESSAGE:%x09%s%nPARENTS:%x09%P%n" 27d9aaff69ac8db9d19918c4d5efb6b3ed2c3210',
            stdout=[
                (
                    "COMMIT:\t5355a13f5ba44d23de9a3090ad976d63d1a60e3e\n"
                    "TREE:\ta2bd09a6cc8a36da7fd43a3b8445967584873e5e\n"
        ...
        fp.register(
            'git log -n 1 --abbrev=40 --full-diff --full-index --remotes main --reverse --pretty=format:"%nCOMMIT:%x09%H%nTREE:%x09%T%nDATE:%x09%aI%nAUTHOR:%x09%an%x09%ae%x09%aI%nCOMMITTER:%x09%cn%x09%ce%x09%cI%nMESSAGE:%x09%s%nPARENTS:%x09%P%n" 0cd26c4deaebd98ff26b8cf20bda15553ef5bdcd',
            stdout=[
                (
                    "COMMIT:\t5355a13f5ba44d23de9a3090ad976d63d1a60e3e\n"
                    "TREE:\ta2bd09a6cc8a36da7fd43a3b8445967584873e5e\n"
        ...
        fp.register(
            'git log -n 1 --abbrev=40 --full-diff --full-index --remotes main --reverse --pretty=format:"%nCOMMIT:%x09%H%nTREE:%x09%T%nDATE:%x09%aI%nAUTHOR:%x09%an%x09%ae%x09%aI%nCOMMITTER:%x09%cn%x09%ce%x09%cI%nMESSAGE:%x09%s%nPARENTS:%x09%P%n" 39c54991d3cd7f4bae68d6b58549e7e2ab084a23',
            stdout=[
                (
                    "COMMIT:\t5355a13f5ba44d23de9a3090ad976d63d1a60e3e\n"
                    "TREE:\ta2bd09a6cc8a36da7fd43a3b8445967584873e5e\n"
        ...
        fp.register(
            'git log -n 1 --abbrev=40 --full-diff --full-index --remotes main --reverse --pretty=format:"%nCOMMIT:%x09%H%nTREE:%x09%T%nDATE:%x09%aI%nAUTHOR:%x09%an%x09%ae%x09%aI%nCOMMITTER:%x09%cn%x09%ce%x09%cI%nMESSAGE:%x09%s%nPARENTS:%x09%P%n" ceff1b9d2d403e83b9c7c39e5baa47eff61a3524',
            stdout=[
                (
                    "COMMIT:\t5355a13f5ba44d23de9a3090ad976d63d1a60e3e\n"
                    "TREE:\ta2bd09a6cc8a36da7fd43a3b8445967584873e5e\n"
        ...
        vcs = GitVCS(".")
        branch: T_Branch = "main"
        commits = vcs.commits(commit="HEAD", number=4, raw=False)
